...
```bash
Sales-Ops-Reconciliation-Analytics/
│
├── README.md
├── assets/
│   ├── project-cover.png
...
│   │   └── source-files.xlsx
│   ├── cleaned/
│   │   ├── clean-reported-data.xlsx
│   │   ├── clean-system-data.xlsx
│   │   └── integrity-summary.xlsx
│   └── outputs/
│       ├── reconciliation-summary.xlsx
│       └── performance-summary.xlsx
│
├── powerbi/
│   └── sales-operations-reconciliation.pbix
│
└── docs/
